...
if args.data == 'IMDB':
    ...
    train_dataset = IMDBDataset(image_feature, target_dict, sex_dict, 'unbiased', eb1_key_list, eb2_key_list, unbiased_key_list, 'train', transform_train)
    valid_dataset = IMDBDataset(image_feature, target_dict, sex_dict, 'unbiased', eb1_key_list, eb2_key_list, unbiased_key_list, 'dev', transform_train)
